        ...
        <div className="flex flex-wrap py-12">
          <div className="p-5 lg:p-10 w-full md:w-1/3">
            ...
            <p className="text-gray-400 mt-3">
              ...
              officia ipsa nobis ut, reprehenderit praesentium nisi deleniti nemo
              laboriosam est expedita! Consequuntur aperiam deleniti vel
          ...
          <div className="p-5 lg:p-10 w-full md:w-1/3">
            ...
            <ul className="flex mt-4">
              <li className="p-2 text-gray-900 bg-white shadow rounded mx-1">
                <svg
                  fill="currentColor"
